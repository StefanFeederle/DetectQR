           ...
           while( true ){    
        	   ...
        	   if( !webcam_image.empty() ){ 
            	   ...
            	   if (markers.size() == 3){
            		   ...
            		   for ( int i = 0; i < alignmentmarkers.size(); i++ ){   
            		    ...
            		    alignmentmarkers.clear();
            		   	...
            		   	//Core.putText(webcam_image, "Slope: "+ ((slope > 0) ? "+" : "-"), new Point(20, 130), font, 0.8, new Scalar(0,0,255), 2);
            		   	//Core.putText(webcam_image, "Dist:  "+ ((dist > 0) ? "+" : "-"), new Point(20, 160), font, 0.8, new Scalar(0,0,255), 2);
    			
            		   	Core.putText(webcam_image, "Topleft", new Point(topleft.x+20, topleft.y+10), font, 0.8, new Scalar(0,0,255), 2);
            		   	Core.putText(webcam_image, "Topright", new Point(topright.x+20, topright.y+10), font, 0.8, new Scalar(0,0,255), 2); 
            		   	Core.putText(webcam_image, "Bottomleft", new Point(bottomleft.x+20, bottomleft.y+10), font, 0.8, new Scalar(0,0,255), 2);
            		   	Core.putText(webcam_image, "Bottomright", new Point(bottomright.x+20, bottomright.y+10), font, 0.8, new Scalar(0,0,255), 2);  
            	   ...
            	   for(int i = 0; i < centersofmarkers.size(); i++){
            		   ...
            		   //Draw Marker ID
            		   Core.putText(webcam_image, String.valueOf(i), new Point(centersofmarkers.get(i).x-35, centersofmarkers.get(i).y+8), font, 0.8, new Scalar(0,0,255), 2);
            	   }
            	   
            	   //Debug: Show Marker Count and Contour Count
            	   //Core.putText(webcam_image, "Markers: "+ markers.size(), new Point(20, 40), font, 1.5, red, 2);
            	   //Core.putText(webcam_image, "Contours: "+ contours.size() +" found", new Point(20, 100), font, 1.5, red, 2);
